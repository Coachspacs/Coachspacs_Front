...
export default function CoursePlayerPage() {
  ...
  return (
    <div className="min-h-[calc(100vh-80px)] flex flex-col lg:flex-row bg-slate-950 text-slate-100">
      ...
      <div className="flex-grow flex flex-col justify-between p-4 sm:p-6 lg:p-8 space-y-6">
        ...
        <div className="flex items-center justify-between gap-4 border-b border-slate-800 pb-4">
          <div>
            <span className="text-xs text-brand-400 font-semibold uppercase tracking-wider">{course.title}</span>
      ...
      {sidebarOpen && (
        <aside className="w-full lg:w-96 glass-card border-t lg:border-t-0 ltr:lg:border-l rtl:lg:border-r border-slate-800 p-6 space-y-6 shrink-0">
                  ...
                  {module.lessons.map((lesson) => {
                    ...
                    return (
                      <button
                        ...
                        className={`w-full p-3 rounded-xl flex items-center justify-between text-left rtl:text-right text-xs transition-all ${
                          isActive
                            ? 'bg-brand-600/20 border border-brand-500 text-white font-bold'
